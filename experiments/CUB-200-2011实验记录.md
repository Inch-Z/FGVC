...
|      Model(input 448) - 多损失函数       |          训练函数           | Test acc(best-epoch) |
| :--------------------------------------: | :-------------------------: | :------------------: |
|       resnet-50<u>(Baseline1)</u>        |                             |      84.12(136)      |
| ECCV-PMG<u>(Baseline2, init_lr=1e-4)</u> |      PMGI_Net_train.py      |      88.38(177)      |
|                 PMGI-V1                  |      PMGI_Net_train.py      |                      |
|              PMGI-V1-Extend              |      PMGI_Net_train.py      |                      |
|                 PMGI-V2                  |    PMGI_Net_V2_train.py     |                      |
|              PMGI-V2-Extend              |    PMGI_Net_V2_train.py     |                      |
|            PMGI-V3(resnet-50)            |      PMGI_Net_train.py      |      88.33(184)      |
|           PMGI-V3(resnet-101)            |      PMGI_Net_train.py      |      89.06(126)      |
|              PMGI-V3-Extend              |      PMGI_Net_train.py      |                      |
|        PMGI-V4(features-size=512)        |      PMGI_Net_train.py      |      86.61(49)       |
|       PMGI-V4(features-size=8192)        |      PMGI_Net_train.py      |      86.50(101)      |
|                 PMGI-V5                  |    PMGI_Net_V5_train.py     |                      |
|             PMGI-V6(avgpool)             |    PMGI_Net_V5_train.py     |      87.28(158)      |
|             PMGI-V6(maxpool)             |    PMGI_Net_V5_train.py     |      84.30(53)       |
|       PMGI-V6_Extend(非渐进式训练)       | PMGI_Net_V6_Extend_train.py |                      |
|                 PMGI-V7                  |    PMGI_Net_V7_train.py     |                      |
|              PMGI-V7-Extend              | PMGI_Net_V7_Extend_train.py |                      |
|                 PMGI-V8                  |    PMGI_Net_V7_train.py     |                      |
|                                          |                             |                      |
|                                          |                             |                      |
|                                          |                             |                      |